        ...
        <>
            <FooterContainer>
                <FooterWrap>
                    ...
                    <SocialMedia>
                        <SocialMediaWrap>
                            <SocialLogo to='/' onClick={toggleHome} >Boss Jhay</SocialLogo>
                            <WebsiteRights>Boss Jhay ™ {new Date().getFullYear()} All Rights reserved.</WebsiteRights>
                            <SocialIcons>
                                ...
                                <SocialIconLink href="//www.twitch.tv" target="_blank" aria-label="Twitch"><FaTwitch /></SocialIconLink>
